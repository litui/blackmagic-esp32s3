...
// DRAM_ATTR const static lcd_cmd_t rm67162_spi_init[] = {
//     {0xFE, {0x00}, 0x01}, // PAGE
...
DRAM_ATTR const static lcd_cmd_t rm67162_qspi_init[] = {
              ...
              uint16_t color)
{
    ...
    uint16_t *color_p = (uint16_t *)malloc(w * h * 2);
    if (!color_p) {
        return;
    }
